...
// of machine-dependent LLVM code to the WDC65816 assembly language.
//
//===----------------------------------------------------------------------===//
...
void WDC65816AsmPrinter::printOperand(const MachineInstr *MI, int OpNum,
  ...
  case MachineOperand::MO_Register:
    O << WDC65816InstPrinter::getRegisterName(MO.getReg());
    return;
...
void WDC65816AsmPrinter::printSrcMemOperand(const MachineInstr *MI, int OpNum,
                                          raw_ostream &O) {
...
void WDC65816AsmPrinter::EmitInstruction(const MachineInstr *MI) {
  WDC65816MCInstLower MCInstLowering(OutContext, *this);
