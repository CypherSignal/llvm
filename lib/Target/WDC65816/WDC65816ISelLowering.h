...
namespace llvm {
  ...
  public:
    explicit WDC65816TargetLowering(const TargetMachine &TM,
    ...
    /// Ty1 to type Ty2. e.g. On WDC65816 it's free to truncate a i16 value in
    ...
    /// necessarily apply to truncate instructions. e.g. on WDC65816, all
